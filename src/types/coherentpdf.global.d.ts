/*
 * coherentpdf.global.d.ts — TypeScript type definitions for Vinaros / CoherentPDF integration
 *
 * These type definitions were written by Alam for use in the Vinaros project.
