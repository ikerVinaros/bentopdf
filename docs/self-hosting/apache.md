...
Host Vinaros using Apache HTTP Server.
...
```bash
sudo mkdir -p /var/www/vinaros
sudo cp -r dist/* /var/www/vinaros/
sudo chown -R www-data:www-data /var/www/vinaros
```

## Step 3: Apache Configuration

Create `/etc/apache2/sites-available/vinaros.conf`:
...
<VirtualHost *:443>
    ServerName your-domain.com
    DocumentRoot /var/www/vinaros

    SSLEngine on
    SSLCertificateFile /etc/letsencrypt/live/your-domain.com/fullchain.pem
    SSLCertificateKeyFile /etc/letsencrypt/live/your-domain.com/privkey.pem

    <Directory /var/www/vinaros>
...
Create `/var/www/vinaros/.htaccess`:
...
```bash
sudo chown -R www-data:www-data /var/www/vinaros
sudo chmod -R 755 /var/www/vinaros
```
