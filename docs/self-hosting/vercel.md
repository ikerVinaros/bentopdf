...
[![Deploy with Vercel](https://vercel.com/button)](https://vercel.com/new/clone?repository-url=https://github.com/alam00000/vinaros)

## Manual Deployment

### Step 1: Fork the Repository

Fork [vinaros/vinaros](https://github.com/alam00000/vinaros) to your GitHub account.
...
| `VITE_BRAND_NAME`       | Custom brand name (replaces "Vinaros")                     |
...
::: warning Large Files
Vercel's serverless functions have a 50MB limit. Since Vinaros is a static site, this shouldn't affect you, but WASM modules are large (~100MB total). Ensure they're served from the `/public` folder.
:::
