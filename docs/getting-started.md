...
Welcome to Vinaros! This guide will help you get up and running quickly.

## What is Vinaros?

Vinaros is a free, open-source, privacy-first PDF toolkit that runs **entirely in your browser**. Your files never leave your device—all processing happens locally using WebAssembly (WASM) technology.

## Quick Start

### Option 1: Use the Hosted Version

Visit [vinaros.com](https://vinaros.com) to use Vinaros instantly—no installation required.
...
curl -O https://raw.githubusercontent.com/alam00000/vinaros/main/docker-compose.yml
docker compose up -d
```
...
Vinaros works best on modern browsers:
...
- [Self-host Vinaros](/self-hosting/)
