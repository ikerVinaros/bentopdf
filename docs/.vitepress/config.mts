...
export default defineConfig({
    title: "Vinaros Docs",
    description: "Documentation for Vinaros - The free, open-source, privacy-first PDF toolkit",
    base: '/docs/',
