...
Thank you for your interest in contributing to Vinaros! This guide will help you get started.
...
git clone https://github.com/YOUR_USERNAME/vinaros.git
cd vinaros
...
See [TRANSLATION.md](https://github.com/alam00000/vinaros/blob/main/TRANSLATION.md) for adding new languages.

## Contributor License Agreement

Before your PR can be merged, you'll need to sign our CLA:

- [Individual CLA (ICLA)](https://github.com/alam00000/vinaros/blob/main/ICLA.md)
- [Corporate CLA (CCLA)](https://github.com/alam00000/vinaros/blob/main/CCLA.md)

## Getting Help

- [GitHub Issues](https://github.com/alam00000/vinaros/issues)
- [Discord Community](https://discord.gg/Bgq3Ay3f2w)

## License

Vinaros is dual-licensed:
